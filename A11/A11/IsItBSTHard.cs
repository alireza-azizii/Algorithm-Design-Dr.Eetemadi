...
namespace A11
{
    public class IsItBSTHard : Processor
    {
        ...
        public bool Solve(long[][] nodes)
        {
            ...
            return IsBSTHard(Nodes[0]);
        }

        public bool IsBSTHard(Node n, long min = long.MinValue, long max = long.MaxValue)
        {
            if (n == null)
            {
                return true;
            ...
            return IsBSTHard(n.Left != null ? Nodes[n.Left.Id] : null, min, n.Key - 1) && IsBSTHard(n.Right != null ? Nodes[n.Right.Id] : null, n.Key, max);
        }
